...
const envSchema = z.object({
	...
	LINKEDIN_AUTHORIZATION_URL: z.url("Invalid LinkedIn authorization URL"),
	LINKEDIN_CALLBACK_URL: z.url("Invalid LinkedIn callback URL"),
...
export class EnvConfig {
	...
	static get LINKEDIN_AUTHORIZATION_URL(): string {
		return parsedEnv.LINKEDIN_AUTHORIZATION_URL;
	}

	static get LINKEDIN_CALLBACK_URL(): string {
		return parsedEnv.LINKEDIN_CALLBACK_URL;
	}

	static get LINKEDIN_TOKEN_URL(): string {
		return parsedEnv.LINKEDIN_TOKEN_URL;
	}

	static get LINKEDIN_GET_USERINFO_URL(): string {
		return parsedEnv.LINKEDIN_GET_USERINFO_URL;
	}
	static get GOOGLE_CALLBACK_URL(): string {
		return parsedEnv.GOOGLE_CALLBACK_URL;
	}
}
